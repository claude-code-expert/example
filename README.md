...
| 문서 | 설명 |
|------|------|
| [Claude Code 치트시트 라이트 (HTML)](https://claude-code-expert.github.io/example/docs/html/claude-code-cheatsheet-ko.html) | v2.1.92 — 단축키, 슬래시 명령어, 설정, 권한 모드를 가볍게 정리한 라이트 버전 |
...
│       ├── claude-code-cheatsheet-ko.html  # Claude Code 치트시트 (라이트 버전)
