...
> Node.js 20은 2026-04-30 EOL이므로 22 이상을 사용한다.
...
# Bedrock Model
# 크로스 리전 추론 프로파일 ID — 리전별 정확한 ID는 Bedrock 콘솔 확인
...
| 스테이징 | Claude Sonnet 4.6 | info | 운영과 동일한 모델로 테스트 |
| 운영 | Claude Sonnet 4.6 | warn | 품질과 비용의 균형 |
