...
| 문서 | 설명 |
|------|------|
| [`claude-code-cheatsheet-ko.html`](guide/claude-code-cheatsheet-ko.html) | Claude Code 치트시트 (v2.1.91) — 키보드 단축키, 슬래시 명령어, 설정, MCP, 권한 모드 전체 정리 (HTML 인터랙티브 버전) |
| [`claude-code-cheatsheet-ko.md`](guide/claude-code-cheatsheet-ko.md) | Claude Code 치트시트 (v2.1.91) — 위와 동일 내용의 Markdown 버전 |
| [`claude-code-unshipped.html`](guide/claude-code-unshipped.html) | Claude Code 미공개 예정 기능 분석 — npm 소스 유출(2026-03-31) 기반 23개 미출시 기능 정리 (HTML 버전) |
| [`claude-code-unshipped.md`](guide/claude-code-unshipped.md) | Claude Code 미공개 예정 기능 분석 — 위와 동일 내용의 Markdown 버전 |
